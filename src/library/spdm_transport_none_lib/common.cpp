    ...
    uintn* transport_message_size, void* transport_message)
{
    ...
    if (session_id != NULL)
    {
        ...
        if (!is_app_message)
        {
            ...
            status = transport_encode_message(
                (const uint32_t*)NULL, message_size, message, &app_message_size,
                app_message_buffer);
    ...
    else
    {
        ...
        status = transport_encode_message((const uint32_t*)NULL, message_size,
    ...
    const void* transport_message, uintn* message_size, void* message)
{
    ...
    secured_message_session_id = (uint32_t*)NULL;
